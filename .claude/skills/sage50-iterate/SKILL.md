...
- An RDP session to `20.51.189.20` open on the Mac, logged in as `rutteradmin`.
...
- rutter-backend running from the branch that has the Sage 50 routes
  ...
  `ngrok http --hostname=eyrutter.ngrok.io 4007`.
- `az` logged in.
...
ITEM=ccaaac29-c76c-41c4-8c79-c0cbfe370e81
